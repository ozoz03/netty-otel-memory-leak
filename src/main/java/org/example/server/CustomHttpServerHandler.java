...
public class CustomHttpServerHandler extends SimpleChannelInboundHandler<Object> {
    ...
    InternalLogger logger = InternalLoggerFactory.getInstance(CustomHttpServerHandler.class);
    ...
    private void writeResponse(ChannelHandlerContext ctx) {
        ...
        writeFuture.addListener(new GenericFutureListener<Future<? super Void>>() {
            ...
            public void operationComplete(Future<? super Void> future) throws Exception {
                logger.info("CONTINUE response writing was completed.");
            }
        });
    }
    ...
    private void writeResponse(ChannelHandlerContext ctx, LastHttpContent trailer, StringBuilder responseData) {
        ...
        writeFuture.addListener(new GenericFutureListener<Future<? super Void>>() {
            @Override
            public void operationComplete(Future<? super Void> future) throws Exception {
                logger.info("Response writing was completed.");
            }
        });
